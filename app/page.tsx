    ...
    <main className="min-h-screen bg-sage-100">
      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-sm z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="playfair text-xl">My Portfolio</h1>
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h1 className="playfair text-6xl mb-4">Châu Ngọc Anh Trí</h1>
            <h2 className="text-2xl text-gray-600 mb-6">Front-End Developer</h2>
            <div className="space-y-2">
              <p>
                <span className="font-semibold">Phone:</span> +84 917 280 180
              </p>
              <p>
              ...
              <p>
                ...
                github.com/anhtri22303
              </p>
            </div>
            <div className="flex gap-4 mt-6">
              <Link
                href="https://www.linkedin.com/in/anhtri/"
              ...
              <span>•</span>
              <Link
                href="https://www.facebook.com/TriCNA.Coder/"
                className="social-link"
              >
                Facebook
              </Link>
          ...
          >
            <div className="space-y-4">
              <p className="text-gray-600 leading-relaxed">
                ...
                Next.js and Spring Boot, with a strong focus on creating
        ...
        >
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-2">
                <span className="text-sm text-gray-500">2021 - 2026</span>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>
                    Designed and developed a responsive front-end for a billiard
                    scoring system, enhancing user experience for both casual
                    and professional players.
                  </li>
                  <li>
                    Integrated real-time scoring updates and smooth UI
                    animations, improving usability and reducing user errors by
                    70%.
                  </li>
                  <li>
                    Collaborated with back-end developers and UX designers,
                    while mentoring interns and conducting code reviews to
                    ensure maintainable and high-quality code.
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2">
                <span className="text-sm text-gray-500">2024 - 2025</span>
                <h3 className="text-xl font-semibold">Front-End Developer</h3>
                <p className="text-gray-600">Software Development Project</p>
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Anhtri22303@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+84 917 280 180</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Hồ Chí Minh, Vietnam</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="py-8 px-4 text-center text-gray-600">
        <p>© 2025 Anh Trí. All rights reserved.</p>
      </footer>
    </main>
  );
}
